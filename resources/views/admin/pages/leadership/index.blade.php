    ...
    <div class="container-fluid">
        ...
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0">Leadership</h4>
            </div>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('leadership.store') }}" method="POST" enctype="multipart/form-data" class="modal-content">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label>Image</label>
                    <input type="file" class="dropify" name="l_img" accept="image/*">
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" class="form-control" name="l_ldn" placeholder="https://linkedin.com/in/username">
                    </div>
                </div>
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" class="form-control" name="l_fc" placeholder="https://facebook.com/username">
                    </div>
                </div>
            </div>
...
$(function () {
    ...
    var table = $('.ytable').DataTable({
        ...
        columns: [
            ...
            { data: 'l_img',       name: 'l_img',  orderable: false, searchable: false, width: '80px' },
            { data: 'l_desg',      name: 'l_desg' },
            { data: 'l_ldn',       name: 'l_ldn',  orderable: false, searchable: false },
            { data: 'l_fc',        name: 'l_fc',   orderable: false, searchable: false },
    ...
    $('body').on('click', '.edit', function () {
        let id = $(this).data('id');
        $.get("{{ url('admin/leadership') }}/" + id + "/edit", function (data) {
